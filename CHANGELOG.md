...
* Save Berkeley Earth TXx scaling with Tglob and offset in a text file for year-to-year comparison
  ([#9](https://github.com/ClimateIndicator/igcc_t_extremes/issues/9), [#37](https://github.com/ClimateIndicator/igcc_t_extremes/pull/37)).
...
Create a release of the version for the analysis for the paper looking at 2022 (Forster et al., [2023](https://essd.copernicus.org/articles/15/2295/2023/)). (Although the date is 2024, the code reflects the status of the analysis in 2023 of 2022.)
